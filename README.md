...
2. Décompressez-le où vous voulez — par exemple
...
profil utilisateur ; le dossier d'installation ne contient rien de personnel et
peut être écrasé lors d'une mise à jour.
