...
- **Le code-barres de l'article au catalogue de colonnes.** Il donne celui de ce
  qui est réellement vendu sur la ligne : pour un article à gamme, le code-barres
  de la **déclinaison** vendue — la taille, la couleur — et non celui de
  l'article, qui désignerait autre chose que ce qui est facturé. À défaut de
  code-barres sur la déclinaison, celui de l'article est repris.

  En XLSX la colonne est écrite en *Texte*, comme les autres libellés : un code
  commençant par un zéro le perdrait en devenant un nombre, et rien ne le
  signalerait.
